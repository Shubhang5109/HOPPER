...
SOURCES = [
    dict(id="SRC:PLANTVILLAGE", name="PlantVillage", domain="Disease image / AI dataset",
         ...
         paper=dict(title="An open access repository of images on plant health to enable the development of mobile disease diagnostics through machine learning and crowdsourcing",
                    authors="Hughes, D.P. & Salathé, M.", year=2015, venue="arXiv:1511.08060",
    ...
    dict(id="SRC:PLANTDOC", name="PlantDoc", domain="Disease image / AI dataset",
         ...
         paper=dict(title="PlantDoc: A Dataset for Visual Plant Disease Detection",
                    authors="Singh, D., Jain, N., Jain, P., Kayal, P., Kumawat, S. & Batra, N.", year=2020,
                    venue="7th ACM IKDD CoDS & 25th COMAD, pp. 249-253",
    ...
    dict(id="SRC:IP102", name="IP102", domain="Disease image / AI dataset",
         ...
         paper=dict(title="IP102: A Large-Scale Benchmark Dataset for Insect Pest Recognition",
                    authors="Wu, X., Zhan, C., Lai, Y-K., Cheng, M-M. & Yang, J.", year=2019,
                    venue="IEEE/CVF CVPR 2019, pp. 8787-8796",
                    url="https://doi.org/10.1109/CVPR.2019.00899")),
    dict(id="SRC:FUNGIDB", name="FungiDB", domain="Pathogen genomics", data_type="Genome sequence & functional annotation",
         ...
         paper=dict(title="FungiDB: an integrated functional genomics database for fungi",
                    authors="Stajich, J.E., Harris, T., Brunk, B.P. et al.", year=2012,
                    venue="Nucleic Acids Research 40(D1):D675-D681",
                    url="https://doi.org/10.1093/nar/gkr918")),
    ...
    dict(id="SRC:PHIBASE", name="PHI-base", domain="Host-pathogen interaction", data_type="Curated interaction phenotype records",
         ...
         paper=dict(title="PHI-base: the multi-species Pathogen-Host Interaction Database in 2025",
                    authors="Urban, M., Cuzick, A., Seager, J. et al.", year=2024,
                    venue="Nucleic Acids Research 53(D1):D826-D838",
                    url="https://doi.org/10.1093/nar/gkae1084")),
    ...
    dict(id="SRC:PRGDB", name="PRGdb", domain="Plant resistance genes", data_type="Known & predicted resistance genes (NBS-LRR emphasis)",
         ...
         paper=dict(title="PRGdb 4.0: an updated database dedicated to genes involved in plant disease resistance process",
                    authors="Calle García, J., Guadagno, A., Paytuvi-Gallart, A. et al.", year=2022,
                    venue="Nucleic Acids Research 50(D1):D1483-D1490",
    ...
    dict(id="SRC:EXPR_ATLAS", name="Expression Atlas", domain="Multi-omics (transcriptomic)", data_type="Gene & protein expression data",
         ...
         paper=dict(title="Expression Atlas: gene and protein expression across multiple studies and organisms",
                    authors="Papatheodorou, I., Fonseca, N.A., Keays, M. et al.", year=2018,
                    venue="Nucleic Acids Research 46(D1):D246-D251",
                    url="https://doi.org/10.1093/nar/gkx1158")),
    dict(id="SRC:PROTEOMEXCHANGE", name="ProteomeXchange", domain="Multi-omics (proteomic)", data_type="Mass-spectrometry proteomics submission/retrieval",
         ...
         paper=dict(title="The ProteomeXchange consortium in 2020: enabling 'big data' approaches in proteomics",
                    authors="Deutsch, E.W., Bandeira, N., Sharma, V. et al.", year=2020,
                    venue="Nucleic Acids Research 48(D1):D1145-D1152", url=None)),
    dict(id="SRC:PRIDE", name="PRIDE", domain="Multi-omics (proteomic)", data_type="Mass-spectrometry proteomics archive",
         ...
         paper=dict(title="The PRIDE database resources in 2022: a hub for mass spectrometry-based proteomics evidences",
                    authors="Perez-Riverol, Y., Bai, J., Bandla, C. et al.", year=2022,
                    venue="Nucleic Acids Research 50(D1):D543-D552",
    ...
    dict(id="SRC:MAIZEGDB", name="MaizeGDB", domain="Crop-specific genomics", data_type="Genetic maps, genomic sequence, gene function",
         ...
         paper=dict(title="MaizeGDB 2018: the maize multi-genome genetics and genomics database",
                    authors="Portwood II, J.L., Woodhouse, M.R., Cannon, E.K. et al.", year=2019,
                    venue="Nucleic Acids Research 47(D1):D1146-D1154",
    ...
    dict(id="SRC:SNPSEEK", name="Rice SNP-Seek", domain="Crop-specific genomics", data_type="SNP genotype data",
         ...
         paper=dict(title="Rice SNP-seek database update: new SNPs, indels, and queries",
                    authors="Mansueto, L., Fuentes, R.R., Borja, F.N. et al.", year=2017,
                    venue="Nucleic Acids Research 45(D1):D1075-D1081",
    ...
    dict(id="SRC:SOYBASE", name="SoyBase", domain="Crop-specific genomics", data_type="Genetic/genomic data, QTL & GWAS loci",
         ...
         paper=dict(title="A new decade and new data at SoyBase, the USDA-ARS soybean genetics and genomics database",
                    authors="Brown, A.V., Conners, S.I., Huang, W. et al.", year=2021,
                    venue="Nucleic Acids Research 49(D1):D1496-D1501",
                    url="https://doi.org/10.1093/nar/gkaa1107")),
    ...
    dict(id="SRC:DROUGHTDB", name="DroughtDB", domain="Stress / phenomics", data_type="Curated drought-stress gene compilation",
         ...
         paper=dict(title="DroughtDB: an expert-curated compilation of plant drought stress genes and their homologs in nine species",
                    authors="Alter, S., Bader, K.C., Spannagl, M. et al.", year=2015,
                    venue="Database 2015:bav046",
                    url="https://doi.org/10.1093/database/bav046")),
    dict(id="SRC:STIFDB2", name="STIFDB2", domain="Stress / phenomics", data_type="Stress-responsive transcription factors & binding sites",
         ...
         paper=dict(title="STIFDB2: an updated version of plant stress-responsive transcription factor database with additional stress signals, stress-responsive transcription factor binding sites and stress-responsive genes in Arabidopsis and rice",
                    authors="Naika, M., Shameer, K., Mathew, O.K., Gowda, R. & Sowdhamini, R.", year=2013,
                    venue="Plant & Cell Physiology 54(2):e8",
                    url="https://pubmed.ncbi.nlm.nih.gov/23314754/")),
    dict(id="SRC:CYVERSE", name="CyVerse", domain="Stress / phenomics infrastructure", data_type="Cloud compute, storage & workflow orchestration",
         ...
         paper=dict(title="The iPlant Collaborative: Cyberinfrastructure for Enabling Data to Discovery for the Life Sciences",
                    authors="Merchant, N., Lyons, E., Goff, S. et al.", year=2016,
                    venue="PLoS Biology 14(1):e1002342",
                    url="https://doi.org/10.1371/journal.pbio.1002342")),
    dict(id="SRC:MGNIFY", name="MGnify", domain="Soil microbiome / metagenomics", data_type="Metagenome-assembled genomes & protein catalogues",
         ...
         paper=dict(title="MGnify: the microbiome sequence data analysis resource in 2023",
                    authors="Richardson, L., Allen, B., Baldi, G. et al.", year=2023,
                    venue="Nucleic Acids Research 51(D1):D753-D759",
